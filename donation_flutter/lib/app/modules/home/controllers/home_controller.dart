...
import 'package:donation_flutter/app/models/user.dart';

import 'package:donation_flutter/app/modules/home/views/svg_wrapper.dart';
import 'package:donation_flutter/app/services/wallet_service.dart';
import 'package:donation_flutter/app/services/web3service.dart';
...
class HomeController extends GetxController with SingleGetTickerProviderMixin {
  ...
  Future<void> getDonationBalance() async {
    loading.value = true;
